...
public class EmployeeServiceTest {
    ...
    void testGetById(){
        ...
        assertEquals("jerlin", result.getName());
    ...
    void testAddEmployee() {
        ...
        dto.setEmpId(1);
        dto.setName("jerlin");
        dto.setEmail("jerlin@example.com");
        dto.setUserName("jerlin123");
        ...
        when(passwordEncoder.encode("jerlin")).thenReturn("jerlin-encoded");
